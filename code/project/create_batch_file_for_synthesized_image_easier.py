...
def create_samples_for_training(id):
    ...
    with open("/project/ace-genetics/jueqiw/code/Autism_Brain_Development/code/project/subjects_ABIDE_lower_35.pkl", "rb") as f:
    ...
    for subject in job_subjects:
        ...
        dir_path = Path(f"/projectnb/ace-genetics/ABIDE_Syn_Easier/ABIDE_{dataset}/sub-{subject_id}")
        ...
        for idx in range(3):
            ...
            atrophy_factor = rng.uniform(0.5, 1, size=n_rois // 2)  # Less extreme atrophy
            expand_factor = rng.uniform(1, 1.5, size=n_rois // 2)   # Less extreme expansion
            lab_np = sitk.GetArrayFromImage(atlas)
